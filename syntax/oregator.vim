...
syn match   define            "^\s*\<\(CHARSET\|DEBUG\|FNC1_SYMBOL\|INF_SYMBOL\|MIF_TEMPLATE\|NAN_SYMBOL\)\>\(\s*'.*';$\)\@="
...
syn match   functions         "\<\(ABS\|ASSIGN\|RGB\|CONTROL\|COUNT\|DATETIME\|EANPZ\|ELEMENT\|EXISTS\|FETCH\|FOLD\|ROUND\|LENGTH\|LOG\|LTRIM\|LZERO\|RTRIM\|STRSTR\|STRSUB\|SUBSTR\|SUM\|VERSION\|QR_VERSION\)\>\((\)\@="
